...
<div class="app-wrap">
  ...
  <aside class="sidebar">
    <div class="sidebar-brand">
      ...
      <div class="sidebar-brand-name">TechMada RH<span><?= $sidebarSubtitle ?? 'Application' ?></span></div>
    </div>
    ...
    <div class="sidebar-user">
      <div class="s-user-row">
        <div class="avatar <?= $userAvatarClass ?? 'av-green' ?>"><?= substr($_SESSION['user_name'] ?? 'XX', 0, 2) ?></div>
        <div>
          <div class="user-name"><?= $_SESSION['user_name'] ?? 'Utilisateur' ?></div>
          <div class="user-role"><?= $_SESSION['user_role'] ?? 'utilisateur' ?></div>
        </div>
      </div>
    </div>
  </aside>
